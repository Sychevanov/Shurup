...
raceName = {'Человек': [human,[0,0,0,0,0,0,]],
            'Эльф': [elf,[+20,0,0,0,0,0,]],
            'Карлик': [dwarf,[0,0,0,0,0,0,]],
            'Гном': [gnome,[0,0,0,0,0,0,]],
            'Хоббит': [hobbit,[0,0,0,0,0,0,]],
            'Полуэльф': [poluelf,[0,0,0,0,0,0,]],
            'ПолуОрк': [poluorc,[0,0,0,0,0,0,]],
            'Полуогр': [poluogre,[0,0,0,0,0,0,]],
