...
#создать функцию для набора учеников рандомнго мальчики девочки(попробовать генераторы)
#создать фкнцию перебора массива  вызовом метода, с проверкой кто сдал экзамен и сразу счетсик кто сдал
#вывести сколько людей сдали экзамен
